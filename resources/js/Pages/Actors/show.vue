        ...
        <div class="container mx-auto px-4 py-16 flex flex-col md:flex-row">
          <div class="flex-none">
            ...
            <ul class="flex items-center mt-4">
              ...
              <li v-if="social.instagram" class="ml-6">
              ...
              <li v-if="social.twitter" class="ml-6">
              ...
              <li v-if="actor.homepage" class="ml-6">
          ...
          <div class="md:ml-24">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-8">
              <div v-for="(movie, index) in knownForMovies" :key="index" class="mt-4">
...
export default defineComponent({
  ...
  setup(props) {
    ...
    onMounted(() => {
      axios.get('/api/actors/' + props.id)
          .then(response => {
            loading.value = false
            actor.value = response.data.actor
            social.value = response.data.social
            knownForMovies.value = response.data.knownForMovies
    ...
    return {
      actor, loading, size, social, knownForMovies, credits
    }
  }
})
</script>
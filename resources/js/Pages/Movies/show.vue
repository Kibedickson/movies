        ...
        <div class="container mx-auto px-4 py-16 flex flex-col md:flex-row">
          ...
          <div class="md:ml-24">
            ...
            <div class="mt-12">
              ...
              <div class="flex mt-4">
                <div v-for="(crew, index) in movie.crew" :key="index" class="mr-8">
                  <div>{{ crew.name }}</div>
      ...
      <div class="movie-images">
        <div class="container mx-auto px-4 py-16">
          ...
          <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8">
            <div v-for="(image, index) in movie.images" :key="index" class="mt-8">
              <a
...
export default defineComponent({
  ...
  setup(props) {
    ...
    return {
      movie, loading, size, isVideoModalOpen, isImageModalOpen, photo, showImageModal
    }
  }
})
</script>